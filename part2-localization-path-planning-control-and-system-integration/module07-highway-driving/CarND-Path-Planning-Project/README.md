# My Additional Notes
## Getting Started
In the project, a car will be self-drived in a highway at a maximum speedof 50 MPH. The car will provide us with the outputs of its Localization and Data Fusion Modules. This last one will give the location of all vehicles on the side of the road where the ego car is.
...
In this [video](https://www.youtube.com/watch?v=7sI3VHFPP0w), the original developer of the code goes through it explaining it. Some relevat time marks:
