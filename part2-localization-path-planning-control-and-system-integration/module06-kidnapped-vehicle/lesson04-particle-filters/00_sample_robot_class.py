...
# Add translation, rotation and measurement noises
myrobot.set_noise(5.0, 0.1, 5.0)

# Set initial pose (X, Y, theta)
myrobot.set(30.0, 50.0, pi/2)

# Turn pi/2 rad clockwise, advance 15 m, and print measurement
myrobot = myrobot.move(-pi/2, 15.0)
print myrobot.sense()

# Turn pi/2 rad clockwise, advance 10 m, and print measurement
