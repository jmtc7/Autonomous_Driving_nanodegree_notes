...
## Further Reading
Some extra resources to properly understand backpropagation:

- [Yes, you should understand backprop](https://medium.com/@karpathy/yes-you-should-understand-backprop-e2f06eab496b#.vt3ax2kg9), by Andrej Karpathy.
- [A lecture from Stanford's CS231n course](https://www.youtube.com/watch?v=59Hbtz7XgjM), by Andrej Karpathy.
